...
const ENTITY_COUNT_CONFIG: Partial<Record<ExtendedEntityType, {
  ...
  client: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'client' } },
  model: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'model' } },
  vendor: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'vendor' } },
  event_hall: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'event_hall' } },
  rental_company: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'rental_company' } },
  supplier: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'supplier' } },
  staff: { table: 'people', businessIdField: 'business_id', additionalFilters: { contact_type: 'staff' } },
