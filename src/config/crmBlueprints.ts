...
export const PLAYBOXXX_BLUEPRINT: CRMBlueprint = {
  ...
  enabledEntityTypes: ['model', 'influencer', 'supplier', 'collab', 'interaction', 'task', 'note', 'asset', 'media', 'customer'],
  features: {
    showStores: false,
    showInventory: false,
    showRoutes: false,
  ...
  entitySchemas: {
    model: {
      ...
      fields: [
        ...
        { key: 'country', label: 'Country', type: 'select', required: true, width: 'half', section: 'location', options: [
        ...
        { key: 'instagram_handle', label: 'Instagram Handle', type: 'text', width: 'half', section: 'social', placeholder: '@username' },
        { key: 'instagram_followers', label: 'Instagram Followers', type: 'number', width: 'half', section: 'social' },
        { key: 'twitter_handle', label: 'Twitter/X Handle', type: 'text', width: 'half', section: 'social', placeholder: '@username' },
        { key: 'twitter_followers', label: 'Twitter/X Followers', type: 'number', width: 'half', section: 'social' },
        { key: 'tiktok_handle', label: 'TikTok Handle', type: 'text', width: 'half', section: 'social', placeholder: '@username' },
        ...
        { key: 'onlyfans_subscribers', label: 'OnlyFans Subscribers', type: 'number', width: 'half', section: 'social', masked: true, maskedRoles: ['admin'] },
        { key: 'total_followers', label: 'Total Followers (All Platforms)', type: 'number', width: 'full', section: 'social', helpText: 'Auto-calculated from all platforms' },
