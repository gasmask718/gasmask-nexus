...
export const TOPTIER_PARTNER_CATEGORIES = [
  ...
  { value: "helicopter_promo", label: "Helicopter", icon: "Plane" },
  { value: "private_chef_promo", label: "Private Chef", icon: "ChefHat" },
  { value: "black_trucks_promo", label: "Black Trucks", icon: "Truck" },
  { value: "sprinter_van_promo", label: "Sprinter Van", icon: "Bus" },
  { value: "party_bus_promo", label: "Party Bus", icon: "PartyPopper" },
  { value: "security_promo", label: "Security", icon: "Shield" },
...
const GASMASK_BLUEPRINT = createGrabbaBlueprint("gasmask", "gasmask", "GasMask", "#FF0000");

const HOTMAMA_BLUEPRINT = createGrabbaBlueprint("hot_mama", "hot_mama", "Hot Mama", "#FF4F9D");
