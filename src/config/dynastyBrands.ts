    ...
    brands: [
      {
        ...
        routes: [
          ...
          { path: '/realestate', icon: Building, label: 'Real Estate', roles: ['admin', 'realestate_worker'] },
        ]
      }
    ]
  },
    ...
    brands: [
      {
        ...
        routes: [
          ...
          { path: '/notifications', icon: Activity, label: 'Notifications' },
          { path: '/settings/automation', icon: Bot, label: 'Automations', roles: ['admin'] },
          { path: '/va-task-center', icon: Users, label: 'VA Task Panel' },
          { path: '/audit-logs', icon: Database, label: 'Logs' },
