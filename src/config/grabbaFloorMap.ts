...
export const FLOOR_2_COMMUNICATION: SkyscraperFloor = {
  ...
  pages: [
    ...
    {
      path: '/grabba/text-center',
      component: 'GrabbaTextCenter',
      label: 'Text Center',
      description: 'SMS messaging and bulk text campaigns',
      status: 'active',
    },
    {
      path: '/grabba/email-center',
      component: 'GrabbaEmailCenter',
      label: 'Email Center',
      description: 'Email campaigns and templates',
      status: 'active',
    },
    {
      path: '/grabba/call-center',
      component: 'GrabbaCallCenter',
      label: 'Call Center',
      description: 'Voice calls and AI dialer',
      status: 'active',
    },
    {
      path: '/grabba/communication-logs',
      component: 'GrabbaCommunicationLogs',
...
export const FLOOR_4_DELIVERY: SkyscraperFloor = {
  ...
  pages: [
    ...
    {
      path: '/driver-debt-collection',
      component: 'DriverDebtCollection',
      label: 'Driver Debt Collection',
      description: 'Track and collect outstanding driver debts',
      status: 'active',
    },
  ],
};
...
export const FLOOR_5_ORDERS: SkyscraperFloor = {
  ...
  pages: [
    ...
    },
    {
      ...
      description: 'Invoice management and billing dashboard',
      status: 'active',
    },
  ],
};
...
export const FLOOR_7_WHOLESALE: SkyscraperFloor = {
  ...
  pages: [
    ...
    {
      path: '/grabba/upload-center',
      component: 'UnifiedUploadCenter',
      label: 'Upload Center',
      description: 'Wholesaler product uploads and approvals',
      status: 'active',
    },
    {
...
export const FLOOR_8_AMBASSADORS: SkyscraperFloor = {
  ...
  pages: [
    ...
    },
    {
      ...
      component: 'AmbassadorPayouts',
      label: 'Ambassador Payouts',
      description: 'Commission payouts and earnings tracking',
      status: 'active',
    },
  ],
};
