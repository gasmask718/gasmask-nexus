...
const quickActions: QuickAction[] = [
  { id: 'broadcast', label: 'Send Broadcast', icon: Send, path: '/os/owner/broadcast', variant: 'default' },
  { id: 'assign-va', label: 'Assign VA', icon: UserPlus, path: '/os/owner/va-routing', variant: 'secondary' },
  { id: 'crm-leads', label: 'Check Leads', icon: Target, path: '/crm/contacts', variant: 'secondary', badge: '12 new' },
  ...
  { id: 'reports', label: 'Reports', icon: FileText, path: '/os/owner/executive-reports', variant: 'outline' },
