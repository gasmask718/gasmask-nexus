  ...
  return (
    <div className="w-full min-h-full max-w-3xl mx-auto space-y-6">
          ...
          {step === "basics" && (
            <>
              <div className="space-y-2">
                ...
                <Input
                  placeholder="e.g. Q1 Reorder Outreach"
                  value={form.name}
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="number"
                  step="0.1"
                  value={form.campaignWeight}
                  onChange={(e) => setForm((f) => ({ ...f, campaignWeight: e.target.value }))}
                />
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setForm((f) => ({ ...f, maxTargets: e.target.value }))}
                />
              </div>
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setForm((f) => ({ ...f, retryDelayMinutes: e.target.value }))}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(c) => setForm((f) => ({ ...f, respectQuietHours: c }))}
                />
              </div>
              <div className="flex items-center justify-between">
          ...
          {step === "launch" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  <span className="text-muted-foreground">Weight:</span> {form.campaignWeight}
                </div>
                <div>
                  <span className="text-muted-foreground">Max Targets:</span> {form.maxTargets}
                </div>
                <div>
                  <span className="text-muted-foreground">Max Attempts:</span> {form.maxAttempts}
                </div>
                <div>
                  <span className="text-muted-foreground">Region:</span> {form.region || "All"}
                </div>
                <div>
                  <span className="text-muted-foreground">Quiet Hours:</span> {form.respectQuietHours ? "✅" : "❌"}
                </div>
              </div>
              <Separator />
              <Button
      ...
      <div className="flex justify-between">
        ...
        {step !== "launch" && (
          <Button disabled={!canProceed} onClick={() => setStep(steps[currentStepIdx + 1].key)} className="gap-2">
