...
const navItems = [
  ...
  { path: "dialer-start", label: "⚡ Auto Dialer", icon: Rocket, highlight: true },
  { path: "dialer-stores", label: "Active Stores", icon: Phone, highlight: true },
  { path: "dialer-prospects", label: "Prospects", icon: Target, highlight: true },
  { path: "dialer-audience", label: "Audience Builder", icon: Target, highlight: true },
  { path: "dialer-console", label: "Dialer Console", icon: Headphones, highlight: true },
  { path: "dialer-history", label: "Call History", icon: Clock },
  { path: "campaign-wizard", label: "Campaign Wizard", icon: Rocket },
