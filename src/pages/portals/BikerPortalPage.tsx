...
const SIMULATION_TASKS = [
  ...
  {
    id: "t3",
    store: "Smoke Shop Plus",
    address: "789 Myrtle Ave",
    type: "Photo Update",
    status: "in_progress",
    priority: "low",
  },
  ...
  {
    id: "t5",
    store: "City Convenience",
    address: "654 Gates Ave",
    type: "Shelf Check",
    status: "pending",
    priority: "medium",
  },
...
const SIMULATION_ACTIVITY: ActivityItem[] = [
  {
    id: "1",
    title: "Store checked",
    description: "Morning Mart - 98 tubes counted",
  ...
  },
  {
    ...
    description: "Corner Deli - Low stock alert",
  ...
  },
  {
    id: "3",
    title: "Task started",
    description: "Bushwick route - 5 stores",
...
function BikerPortalContent() {
  ...
  return (
                  ...
                  {storesChecked.map((store) => (
                    <div key={store.id} className="flex items-center justify-between p-3 rounded-lg border bg-muted/30">
                      ...
                      <div className="text-right">
                        <p className="text-sm">
                          {store.tubesCount} tubes • {store.shelfCount} shelves
                        </p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                ...
                {tasks.slice(0, 4).map((task) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`h-2 w-2 rounded-full ${task.priority === "high" ? "bg-destructive" : task.priority === "medium" ? "bg-amber-500" : "bg-muted-foreground"}`}
                      />
                      <div>
                        <p className="font-medium">{task.store}</p>
          ...
          <div className="space-y-6">
            ...
            <HudCard title="Recent Activity" icon={<History className="h-4 w-4" />} variant="default">
              <ActivityFeed items={activity} isSimulated={activitySimulated} maxItems={5} />
            </HudCard>
          </div>
        </div>
    ...
    {/* Store Capture FAB — sibling of layout to avoid clipping by ancestor containers */}
