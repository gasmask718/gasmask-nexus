...
export default function WholesalerMessages() {
  ...
  const handleSelectThread = (id: string) => {
    ...
    navigate(`/portal/wholesaler/messages/${id}`);
  };

  const handleBack = () => {
    setSelectedThread(undefined);
    navigate('/portal/wholesaler/messages');
  };
            ...
            {selectedThread ? (
              ...
              <div className="h-full flex items-center justify-center text-muted-foreground">
                <div className="text-center">
                  ...
                  <h2 className="text-xl font-semibold mb-2">Wholesaler Messages</h2>
                  <p>Communicate with stores and customers</p>
                </div>
              </div>
            )}
          </div>
