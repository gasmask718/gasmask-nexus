...
const utNavSections: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/os/unforgettable/supplier-inbox-v2', label: 'Inbox + Threads', icon: Mail },
      { path: '/os/unforgettable/auto-outreach', label: 'Auto Outreach', icon: Send },
      { path: '/os/unforgettable/shipping-quotes', label: 'Shipping Quotes', icon: Calculator },
      { path: '/os/unforgettable/auto-finder', label: 'Auto Finder', icon: Target },
