        ...
        <AuthProvider>
          <BusinessProvider>
            <Routes>
              ...
              <Route path="/portal/store/team" element={<ProtectedRoute><StoreTeam /></ProtectedRoute>} />
              <Route path="/portal/join" element={<ProtectedRoute><JoinOrg /></ProtectedRoute>} />
              ...
              <Route path="/portal/wholesaler/team" element={<ProtectedRoute><WholesalerTeam /></ProtectedRoute>} />
              ...
              <Route path="/grabba/follow-up-settings" element={<ProtectedRoute><RequireRole allowedRoles={['admin', 'employee']}><Layout><FollowUpSettings /></Layout></RequireRole></ProtectedRoute>} />
              <Route path="/grabba/daily-briefing" element={<ProtectedRoute><RequireRole allowedRoles={['admin', 'employee']}><Layout><DailyBriefing /></Layout></RequireRole></ProtectedRoute>} />
