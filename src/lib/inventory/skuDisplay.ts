...
export const CANONICAL_TUBE_SKUS: CanonicalSku[] = [
  ...
  { product_id: '04336f6d-d69b-4ec8-8571-7088783b31d6', display: 'Hotscolatti Mix',     parent_brand: 'Hotscolatti', order: 4 },
  { product_id: '1c4f112e-97a1-4430-aae0-f1fcc0229a85', display: 'Hotscolatti Dark',    parent_brand: 'Hotscolatti', order: 5 },
  { product_id: '27e21aec-21a2-4ce7-9515-dbfd618a27c6', display: 'Hotscolatti Light',   parent_brand: 'Hotscolatti', order: 6 },
  { product_id: 'fcfe5469-e9d3-40f3-8bf4-a4349086e1c3', display: 'Hotscolatti Bros',    parent_brand: 'Hotscolatti', order: 7 },
  { product_id: '2dfcbd00-0e44-4cd1-b80d-b00a33b123c5', display: 'HotMama',             parent_brand: 'HotMama',     order: 8 },
...
// Reverse map: product_id → canonical brand string (matches UpdateInventoryModal <Select> values).
// Use this when a writer knows the SKU but must satisfy store_tube_inventory.brand NOT NULL.
export const PRODUCT_ID_TO_BRAND: Record<string, string> = {
  'dd5e14c0-d6c5-403a-a2d7-504181b0f4ea': 'gasmasktubes',       // GasMask Tubes
  '170adb8f-ac4e-40f4-a283-38730d30c5de': 'gasmask',            // GasMask Bags
  'e3eea682-831e-4913-8b0e-563bc1325a1f': 'gasmask',            // GasMask Redtops (parent brand)
  '04336f6d-d69b-4ec8-8571-7088783b31d6': 'hotscolatti',        // Hotscolatti Mix
  '1c4f112e-97a1-4430-aae0-f1fcc0229a85': 'hotscolatti-dark',   // Hotscolatti Dark
  '27e21aec-21a2-4ce7-9515-dbfd618a27c6': 'hotscolatti-light',  // Hotscolatti Light
  'fcfe5469-e9d3-40f3-8bf4-a4349086e1c3': 'hotscolatti',        // Hotscolatti Bros
  '2dfcbd00-0e44-4cd1-b80d-b00a33b123c5': 'hotmama',            // HotMama
  '2d28e463-5296-4d42-b548-896d18ee906e': 'grabba',             // Grabba R Us
};

export function brandForProductId(productId: string | null | undefined): string | null {
  if (!productId) return null;
  return PRODUCT_ID_TO_BRAND[productId] ?? null;
}
