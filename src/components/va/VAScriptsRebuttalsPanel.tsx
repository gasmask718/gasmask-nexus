...
export function VAScriptsRebuttalsPanel() {
    ...
    <div className="h-full flex flex-col bg-slate-800/40">
      ...
      <Tabs value={tab} onValueChange={setTab} className="flex-1 flex flex-col min-h-0">
        ...
        <ScrollArea className="flex-1 min-h-0">
          <TabsContent value="script" className="m-0"><ScriptTab /></TabsContent>
          <TabsContent value="packages" className="m-0"><PackagesTab /></TabsContent>
          <TabsContent value="objections" className="m-0"><ObjectionsTab /></TabsContent>
