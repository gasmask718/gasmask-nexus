...
export default function BulkUploadModal({ open, onOpenChange, onSuccess, canUpload = true }: BulkUploadModalProps) {
  ...
  function findBestSchemaMatch(
    ...
    const aliases: Record<string, string[]> = {
      ...
      // Invoice & Payment fields — extensive aliases for real-world spreadsheets
      'invoice_amount': ['invoiceamount', 'amount', 'total', 'invoicetotal', 'totalamount', 'price', 'cost',
        'grandtotal', 'ordertotal', 'orderamount', 'invoicevalue', 'balance', 'balancedue',
        'totaldue', 'amountdue', 'amountowed', 'owed', 'charge', 'totalcharge', 'billamount',
        'billamt', 'inv', 'invamt', 'invtotal', 'subtotal', 'nettotal', 'grosstotal'],
      'invoice_payment_status': ['invoicepaymentstatus', 'paymentstatus', 'paid', 'paidstatus',
        'status', 'paystatus', 'ispaid', 'paymentstate', 'paystate', 'paidunpaid',
        'collected', 'settled', 'cleared', 'paymentreceived', 'paymentcomplete',
        'outstanding', 'paymentoutstanding', 'invoicestatus'],
      'invoice_payment_method': ['invoicepaymentmethod', 'paymentmethod', 'howpaid', 'method',
        ...
        'modeofpayment', 'methodofpayment', 'cashcheck', 'cashorcredit',
      ...
      'invoice_amount_paid': ['invoiceamountpaid', 'amountpaid', 'paidamount',
        ...
        'collected', 'cashreceived', 'paymentsreceived', 'paymentamount', 'payamt'],
      'invoice_due_date': ['invoiceduedate', 'duedate', 'due', 'paymentdue',
        'duebydate', 'dueby', 'payby', 'paymentduedate', 'deadline', 'netterms'],
      'invoice_date': ['invoicedate', 'dateofinvoice', 'invoicecreated',
        'billingdate', 'billdate', 'orderdate', 'dateoforder', 'transactiondate',
        'txndate', 'saledate', 'dateofsale', 'purchasedate', 'dateofpurchase',
        'invoiceissued', 'issuedate', 'dateissued', 'createddate', 'createdat'],
      'invoice_brand': ['invoicebrand', 'productbrand', 'brandsold', 'brandname'],
      'invoice_notes': ['invoicenotes', 'invoicedescription', 'invoicememo',
        'paymentnotes', 'paymentnote', 'ordernotes', 'billingnotes', 'description',
        'memo', 'remarks', 'invoiceremarks', 'paymentremarks', 'details'],
      'invoice_paid_at': ['invoicepaidat', 'datepaid', 'paiddate', 'paidon',
        'paymentdate', 'receiveddate', 'dateofpayment', 'datecollected',
        'collectedon', 'settleddate', 'cleareddate', 'paymentreceiveddate'],
