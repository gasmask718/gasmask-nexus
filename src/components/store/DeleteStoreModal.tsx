/**
 * DeleteStoreModal — Governed store deletion with password re-authentication.
...
export function DeleteStoreModal({ open, onOpenChange, storeId, storeName }: DeleteStoreModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success(`"${storeName}" has been deleted. It can be recovered from Security & Governance.`);
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            You are about to delete <strong>"{storeName}"</strong>. This action is logged
