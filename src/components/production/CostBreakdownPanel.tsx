              ...
              <div>
                ...
                <div className="mb-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <Label htmlFor="use-specific-workers" className="text-xs cursor-pointer">
                      Select specific workers (pulls rates from worker profiles)
                    </Label>
                  </div>
                  ...
                  {useSpecificWorkers ? (
                    <div className="border rounded-md p-2 max-h-[120px] overflow-y-auto space-y-1">
                      {workers.length === 0 ? (
                        <p className="text-xs text-muted-foreground p-1">No active workers found.</p>
                      ) : (
                        workers.map(w => {
                          const wAny = w as any;
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {laborModel === 'per_box' && !useSpecificWorkers && (
                    <div className="space-y-1">
                      <Label className="text-xs">Rate ($/box)</Label>
                      <div className="relative">
                        <span className="absolute left-2.5 top-2.5 text-xs text-muted-foreground">$</span>
                        <Input
                          type="number"
                  ...
                  {laborModel === 'flat_day' && !useSpecificWorkers && (
                    <div className="space-y-1">
                      <Label className="text-xs">Rate ($/day per worker)</Label>
                      <div className="relative">
                        <span className="absolute left-2.5 top-2.5 text-xs text-muted-foreground">$</span>
                        <Input
                          type="number"
