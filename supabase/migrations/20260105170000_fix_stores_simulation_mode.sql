-- =====================================================
-- FIX: Add is_simulation to stores table and update sync trigger
-- This fixes the issue where stores created in simulation mode
-- don't appear correctly because store_master sync doesn't set is_simulation
-- =====================================================
