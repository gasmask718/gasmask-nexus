...
BEGIN
  ...
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items) LOOP
    ...
    -- Prefer authoritative Dynasty Direct pricing columns
    -- (dtc_price_b / store_price_a). Fall back to legacy retail_price /
    -- store_price only when the new columns are NULL or 0.
